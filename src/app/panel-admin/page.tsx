...
const AdminPage: NextPage = () => {
  ...
  useEffect(() => {
    ...
    loadAppointments()
    loadCancelledAppointments()
  }, [loadAppointments, loadCancelledAppointments])
  ...
  return (
    <main className='flex flex-col items-center justify-center mx-auto gap-y-6 py-4 px-2 w-full max-w-lg mt-[150.5px]'>
      ...
      <section className='flex flex-col items-center w-full'>
        <header className='w-full flex justify-between'>
          <h1 className='text-xl text-left font-medium'>Clientes</h1>
        ...
        <div className='flex justify-center w-full gap-x-4 mx-2 my-5 px-3'>
          <input
            ...
            placeholder='Escribe el nombre o teléfono de un cliente'
            className='w-full py-1 px-2 focus:outline focus:outline-secondary rounded-lg'
          />
          <button
            type='button'
            className='text-white bg-primary rounded-lg p-2 hover:opacity-75'
          >
        ...
        <div className='flex w-full justify-center my-5 gap-6'>
          <button
            ...
            className='min-w-[115px] text-white bg-primary rounded-lg p-2 hover:opacity-75'
          >
            Agregar Cliente
          </button>
          <button
        ...
        <article className=' flex flex-col justify-between items-end w-full my-5'>
          <div className='w-full flex justify-between items-center'>
            <p className='text-xl text-left font-medium'>Citas agendadas</p>
          ...
          <div className='w-full flex justify-between items-center'>
            <p className='text-xl text-left font-medium'>Citas completadas</p>
            <p className='text-xl text-left font-medium px-2'>3</p>
          </div>

          <div className='w-full flex justify-between items-center'>
            <p className='text-xl text-left font-medium'>Citas canceladas</p>
            <p className='text-xl text-left font-medium px-2'>
      ...
      <section className='flex flex-col items-center w-full'>
        <article className=' flex items-end w-full my-5'>
          <p className='text-xl text-left font-medium w-72'>Próxima cita</p>
        ...
        <div className='flex justify-center w-full gap-x-4 my-5'>
          <button
            ...
            className='min-w-[115px] text-white bg-primary rounded-lg p-2 hover:opacity-75'
          >
            <Link href={'/panel-admin/customers'}>Clientes</Link>
          </button>
          <button
            type='button'
            className='min-w-[115px] text-white bg-primary rounded-lg p-2 hover:opacity-75'
          >
            <Link href={'/panel-admin/appointments'}>Citas</Link>
          </button>
        </div>
      </section>
