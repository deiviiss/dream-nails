...
import { AppointmentCard } from '@/app/panel-admin/apointments/AppointmentCard'
import { AppointmentFormCreate } from '@/app/panel-admin/apointments/AppointmentFormCreate'
  ...
  return (
    <main className='flex flex-col items-center justify-center mx-auto gap-y-6 py-4 px-2 w-full max-w-lg mt-[150.5px]'>
      <header className="w-full flex justify-between">
        ...
        <button className='px-2' onClick={handleClickAddAppointment} ><AiOutlinePlus></AiOutlinePlus></button>
      </header>
      ...
      <Modal open={openModalAddAppointment} setOpen={setOpenModalAddAppointment} title='Agendar cita'>
        <AppointmentFormCreate setOpen={setOpenModalAddAppointment}></AppointmentFormCreate>
      </Modal>
    </main>
  )
}
