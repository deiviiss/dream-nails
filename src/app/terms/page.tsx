    ...
    <>
      <div className='text-primary tracking-wide mb-20 mt-[150px] py-2'>
        <div className='max-w-[920px] mx-auto my-5 '>
          ...
          <div className='px-3'>
            <h2 className='text-2xl font-bold py-4'>1. Servicios y Reservas</h2>
            ...
            <h2 className='text-2xl font-bold py-4'>2. Privacidad de los Datos</h2>
            ...
            <h2 className='text-2xl font-bold py-4'>3. Feedback</h2>
            ...
            <h2 className='text-2xl font-bold py-4'>4. Propiedad Intelectual</h2>
            ...
            <h2 className='text-2xl font-bold py-4'>5. Exclusión de Garantías</h2>
            ...
            <h2 className='text-2xl font-bold py-4'>6. Limitación de Responsabilidad</h2>
            ...
            <h2 className='text-2xl font-bold py-4'>7. Modificaciones de los Términos y Condiciones</h2>
            ...
            <h2 className='text-2xl font-bold py-4'>8. Ley Aplicable</h2>
