      ...
      <div className='flex items-center justify-center pt-[150.5px] bg-legal-gradient'>
        <div className='max-w-[920px] mx-auto my-5 '>
          ...
          <button className='flex mt-8 text-center mx-auto'>
            <Link className='py-5 px-12 text-white transition-all duration-200 bg-primary rounded border-2 border-primary hover:bg-transparent hover:text-primary' href='/dates'>Contáctanos</Link>
          </button>
        </div>
      </div>
    </>
