        ...
        <>
          <div className='absolute flex flex-col justify-between items-center w-screen h-screen top-0 right-0 py-3 bg-primary-gradient'>
            <div className="flex items-center justify-between max-w-[768px] container mx-auto px-2">
              ...
              <button onClick={() => { setIsOpen((prev) => !prev) }} className="flex items-center justify-around border-transparent duration-400 px-2 pr-5" >
            ...
            <h1 className=' opacity-20 tracking-[8px] text-center text-5xl pb-5 mb-5'>DREAM NAILS</h1>
          </div>
        </>
      )}
    </div>
