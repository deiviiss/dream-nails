  ...
  return (
    <section className="mx-auto w-full max-w-[820px]">
      <div className='flex flex-col items-center'>
        ...
        <div className="flex w-full justify-between my-1 sm:px-14">
        ...
        services?.map(service => {
          return (
            <div key={service.id} className='flex justify-between gap-4 mt-4 px-6 sm:px-14 text-lg'>
              <p className='w-[50ch] border-white border-b-2 hover:border-accent hover:border-b-2 transition ease-in-out delay-150 duration-300 cursor-pointer'>{service.name}</p>
